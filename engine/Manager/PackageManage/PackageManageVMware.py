        ...
        try:
            ...
            for vmFilename in vmFilenames:
                if vmFilename.endswith(".ova"):
                    logging.debug("runImportPackage(): Importing " + str(vmFilename))
            ...
            #now change the names of the vms in the experiment file
            experimentXML = self.ec.getExperimentXMLFileData(os.path.basename(targetPathBase))
            vms = experimentXML['xml']['testbed-setup']['vm-set']['vm']
            ...
            self.ec.writeExperimentXMLFileData(experimentXML,os.path.basename(targetPathBase))
            self.ec.writeExperimentJSONFileData(experimentXML,os.path.basename(targetPathBase))
